...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/jobgr/stack/Computer/Documenten/Avans Hogeschool/Programmeerbare hardware/week 3/Werkende versie/week_3/week_3.cache/compile_simlib/riviera"
  fi
