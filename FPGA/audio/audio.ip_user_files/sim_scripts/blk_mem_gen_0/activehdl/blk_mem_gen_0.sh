...
#
# Generated by Vivado on Mon Mar 12 15:41:57 +0100 2018
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/stan/CloudStation/workspaces/workspace Vivado/audio/audio.cache/compile_simlib/activehdl"
  fi
